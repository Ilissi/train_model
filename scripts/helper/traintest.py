...
parser = argparse.ArgumentParser(formatter_class=argparse.RawTextHelpFormatter, epilog = '{}\n\n{}'.format(
        'example : traintest.py /absolute/path/to/split.py /absolute/path/to/config/splitconf.py /absolute/path/to/train.py /absolute/path/to/config/trainconf.py /absolute/path/to/test.py /absolute/path/to/config/testconf.py',
        'example : traintest.py -vv -i 100 /absolute/path/to/split.py /absolute/path/to/config/splitconf.py /absolute/path/to/train.py /absolute/path/to/config/trainconf.py /absolute/path/to/test.py /absolute/path/to/config/testconf.py'
))
...
parser.add_argument('-i', '--iterations', help = 'number of iterations', default = 100, type = int, metavar = 'n')
...
for i in range(args.iterations):
    ...
    if args.verbose > 0: print('Starting iteration {}'.format(i))
